        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm flex flex-row">
              <SlCalender className="mr-2"/> {formatDate(post.createdDate)}
            </p>
          </div>
        </div>
      ))}
...
export default RecentSidePosts;
