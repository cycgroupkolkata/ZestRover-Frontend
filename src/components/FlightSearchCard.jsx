        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-between items-center gap-4">
          ...
          <div className="w-full sm:flex-1 text-left">
            ...
            <Menu as="div" className="relative  inline-block text-left">
              <div>
                <MenuButton className="inline-flex border-none outline-none focus:outline-none w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                  {adults} adults - {children} child - {infants} room
                  <ChevronDownIcon
                    aria-hidden="true"
